...
from src import info, session, BASE_URL, MAX_LIST_SIZE, retry, stop_never, wait_random_exponential, retry_if_exception_type
...
retry_config = {
    ...
    'after': lambda retry_state: info(f"Retrying ({retry_state['attempt_number']}): {retry_state['outcome']}"),
